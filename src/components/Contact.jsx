...
const Contact = () => {
    ...
    return (
      <section
        id="contact"
        className="bg-background-light dark:bg-background-dark font-display text-gray-500 dark:text-gray-400 min-h-screen flex flex-col"
      >
          ...
          <div className="w-full max-w-4xl text-center">
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="text-left flex-1">
                      ...
                      <p className="text-sm break-all text-gray-600 dark:text-gray-400 group-hover:text-primary transition-colors">
                        {link.label}
                      </p>
                    </div>
            ...
            <div>
              <motion.h1
                ...
                className="px-8 mt-5 md:w-1/4 mx-auto py-3 rounded-xl bg-primary text-black font-semibold shadow-lg hover:shadow-xl transition-all"
              >
                Let’s work together
              </motion.h1>
            </div>
